...
The published Docker image is built on the official [`python:3.9-slim-bookworm`](https://hub.docker.com/_/python) image and inherits the licenses of Debian and the Python distribution it carries.
